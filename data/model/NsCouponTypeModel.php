...
class NsCouponTypeModel extends BaseModel {
    ...
    public function getCouponTypeListByGoodsdetail($goods_id)
    {
    	...
    	$list = $this->alias('nct')
    	->join('ns_coupon_goods ncg',' nct.coupon_type_id = ncg.coupon_type_id','left')
    	->field(' nct.coupon_type_id, nct.shop_id, nct.coupon_name, nct.money, nct.count, nct.max_fetch, nct.at_least, nct.need_user_level, nct.range_type, nct.is_show, nct.start_time, nct.end_time, nct.create_time, nct.update_time, nct.fixed_term')

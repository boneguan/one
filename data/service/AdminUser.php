...
class AdminUser extends User implements IAdmin
{
    ...
    public function getUserQuanxian($uid){
    	
    	$user_admin = new AdminUserModel();   	
    	$user_admin_info = $user_admin->getInfo(["uid"=>$uid]);

    	$auth_group = new AuthGroupModel();
    	$auth_group_info = $auth_group->getInfo(["group_id"=>$user_admin_info['group_id_array']]);

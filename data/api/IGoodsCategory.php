...
interface IGoodsCategory
{
     ...
     * @param unknown $data
     */
    function addOrEditGoodsCategory($category_id, $category_name, $short_name, $pid, $is_visible, $keywords='', $description='', $sort=0, $category_pic, $attr_id=0, $attr_name='', $pc_custom_template, $wap_custom_template,$pc_custom_detail_template, $wap_custom_detail_template);

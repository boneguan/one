...
class Goods extends BaseController
{
     ...
     *
     * @return \data\model\NsGoodsModel
     */
    ...
    public function addGoodsCategory()
    {
        ...
        if (request()->isAjax()) {
            ...
            $pc_custom_detail_template = request()->post("pc_custom_detail_template", "");
            $wap_custom_detail_template = request()->post("wap_custom_detail_template", "");

            $result = $goodscate->addOrEditGoodsCategory(0, $category_name, $short_name, $pid, $is_visible, $keywords, $description, $sort, $category_pic, $attr_id, $attr_name, $pc_custom_template, $wap_custom_template,$pc_custom_detail_template, $wap_custom_detail_template);
    ...
    public function updateGoodsCategory()
    {
        ...
        if (request()->isAjax()) {
            ...
            $result = $goodscate->addOrEditGoodsCategory($category_id, $category_name, $short_name, $pid, $is_visible, $keywords, $description, $sort, $category_pic, $attr_id, $attr_name, $pc_custom_template, $wap_custom_template,$pc_custom_detail_template, $wap_custom_detail_template, $levels);
            return AjaxReturn($result);
        } else {

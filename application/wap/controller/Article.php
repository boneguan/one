...
class Article extends Controller
{
    ...
    public function showArticle()
    {
        ...
        $this->assign('img', $img);
        $articleClass = $article->getArticleClassDetail($ArticleDetail['class_id']);
        $tpl = empty($articleClass['wap_custom_detail_template']) ? 'showArticle' : trim($articleClass['wap_custom_detail_template']);

        return view($this->style . 'Article/'.$tpl);
    }
    ...
    public function articleList()
    {
        ...
        $tpl = empty($articleClass['wap_custom_template']) ? 'articleList' : trim($articleClass['wap_custom_template']);
